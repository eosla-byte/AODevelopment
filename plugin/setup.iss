...
WizardImageFile=A:\AO_DEVELOPMENT\AODevelopment\plugin\Resources\installer_cover_v1.5.3.bmp
WizardSmallImageFile=A:\AO_DEVELOPMENT\AODevelopment\plugin\Resources\installer_cover_v1.5.3.bmp
Compression=lzma
SolidCompression=yes
PrivilegesRequired=lowest
Uninstallable=yes
UninstallDisplayIcon={app}\AOdev.dll
...
; Cleanup potential crumbs in other locations just in case (optional, but safe)
Type: files; Name: "{userappdata}\Autodesk\Revit\Addins\2023\AOdev.addin"
Type: filesandordirs; Name: "{userappdata}\Autodesk\Revit\Addins\2023\AOdev"
